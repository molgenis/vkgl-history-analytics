...
#ggtitle("Classification history of all variants in the VKGL July 2023 public consensus release")
#ggsave("vkgl-july2023.png", width = 11, height = 6)

#ggtitle("History of variants in the VKGL July 2023 public consensus release with >1 different lifetime classifications")
#ggsave("vkgl-july2023-gt1clsf.png", width = 11, height = 6)

#ggtitle("History of variants that have appeared in the VKGL public consensus that are not part of the July 2023 release")
#ggsave("vkgl-notinjuly2023.png", width = 11, height = 6)
...
#ggtitle("History of variants in the VKGL July 2023 public consensus release with any lifetime LP-to-LB or LB-to-LP transition")
#ggsave("vkgl-july2023-lp-lb-trans.png", width = 11, height = 6)

#ggtitle("History of Y-chromosome variants that have appeared in any VKGL public consensus release")
#ggsave("vkgl-july2023-y.png", width = 11, height = 6)

#ggtitle("History of BRCA1 insertion variants in the VKGL July 2023 public consensus release")
#ggsave("vkgl-july2023-brca1-ins.png", width = 11, height = 6)
